...
{
  "$end", "error", "$undefined", "NUM", "AS", "MD", "OP", "CP", "$accept",
  "statement", "expr", "term", "factor", YY_NULL
};
#endif
...
#line 40 "com.y"
    {
			if (t_count == 1) {(yyvsp[(1) - (1)].node).str = malloc(100);
							   char *temp = newVar();
							   sprintf((yyvsp[(1) - (1)].node).str, "Assign %s to %s\n",(yyvsp[(1) - (1)].node).label, temp);
							   (yyvsp[(1) - (1)].node).label = temp;
						 	   }

			printf("%sprint %s", (yyvsp[(1) - (1)].node).str, (yyvsp[(1) - (1)].node).label);}
    break;

  case 3:
/* Line 1792 of yacc.c  */
#line 50 "com.y"
    { (yyval.node).str = malloc(strlen((yyvsp[(1) - (3)].node).str)+strlen((yyvsp[(3) - (3)].node).str)+100);
						 (yyval.node).label = newVar();
						 char temp[10] = "+";
						 if(temp[0] == (yyvsp[(2) - (3)].node).str[0]) strcpy(temp, "Plu"); else strcpy(temp, "Min");
						 sprintf((yyval.node).str, "%s%sAssign %s %s %s to %s\n",(yyvsp[(1) - (3)].node).str, (yyvsp[(3) - (3)].node).str, (yyvsp[(1) - (3)].node).label, temp, (yyvsp[(3) - (3)].node).label, (yyval.node).label);
						 }
    break;
...
#line 57 "com.y"
    { 
				 (yyval.node).label = (yyvsp[(1) - (1)].node).label;
				 (yyval.node).str = (yyvsp[(1) - (1)].node).str;}
    break;
...
#line 63 "com.y"
    { (yyval.node).str = malloc(strlen((yyvsp[(1) - (3)].node).str)+strlen((yyvsp[(3) - (3)].node).str)+100);
						 (yyval.node).label = newVar();
						   char temp[10] = "*";
						   if(temp[0] == (yyvsp[(2) - (3)].node).str[0]) strcpy(temp, "Mul"); else strcpy(temp, "Div");
						   sprintf((yyval.node).str, "%s%sAssign %s %s %s to %s\n",(yyvsp[(1) - (3)].node).str, (yyvsp[(3) - (3)].node).str, (yyvsp[(1) - (3)].node).label, temp, (yyvsp[(3) - (3)].node).label, (yyval.node).label); }
    break;
...
/* Line 1792 of yacc.c  */
#line 75 "com.y"
    {(yyval.node).str = (yyvsp[(2) - (3)].node).str;(yyval.node).label = (yyvsp[(2) - (3)].node).label;}
    break;

  case 8:
/* Line 1792 of yacc.c  */
#line 76 "com.y"
    {(yyval.node).str = malloc(100); (yyval.node).label = malloc(100); 
		  (yyval.node).label = number_into_text(atoi((yyvsp[(1) - (1)].node).str)); t_count++;}
    break;
